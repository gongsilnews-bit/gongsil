    ...
    async function showRegisterProfileModal(user) {
        ...
        if (!modal) {
            ...
            style.innerHTML = `
                ...
                .greg-term-box { height:110px; overflow-y:auto; font-size:12px; color:#666; background:#f9f9f9; padding:12px; border:1px solid #ddd; border-radius:6px; margin:4px 0 16px 30px; line-height:1.6; }
                    ...
                    <form id="gregForm">
                        ...
                        <div class="greg-terms">
                            ...
                            <label class="greg-term-item">
                                ...
                                <span><strong>[필수]</strong> 이용약관동의</span>
                            </label>
                            <div class="greg-term-box">
                            ...
                            <label class="greg-term-item">
                                ...
                                <span><strong>[필수]</strong> 개인정보 수집 및 이용에 대한 안내</span>
                            </label>
                            <div class="greg-term-box">
                            ...
                            <label class="greg-term-item">
                                ...
                                <span><strong>[필수]</strong> 객원 기자 활동 및 책임 귀속 동의서</span>
                            </label>
                            <div class="greg-term-box">
                            ...
                            <label class="greg-term-item">
                                ...
                                <span><strong>[선택]</strong> 이벤트 등 프로모션 알림 메일 수신</span>
                            </label>
                        </div>
